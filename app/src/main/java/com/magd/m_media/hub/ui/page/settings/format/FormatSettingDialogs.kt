package com.magd.m_media.hub.ui.page.settings.format
...
import com.magd.m_media.hub.ui.common.stringState
import com.magd.m_media.hub.ui.component.ConfirmButton
import com.magd.m_media.hub.ui.component.DialogSingleChoiceItem
import com.magd.m_media.hub.ui.component.DialogSingleChoiceItemVariant
import com.magd.m_media.hub.ui.component.DialogSubtitle
import com.magd.m_media.hub.ui.component.DialogSwitchItem
import com.magd.m_media.hub.ui.component.DismissButton
import com.magd.m_media.hub.ui.component.OutlinedButtonChip
import com.magd.m_media.hub.ui.component.PreferenceSubtitle
import com.magd.m_media.hub.ui.component.SealDialog
import com.magd.m_media.hub.ui.component.SealTextField
import com.magd.m_media.hub.ui.page.downloadv2.configure.PreferencesMock
...
import com.magd.m_media.hub.util.CONVERT_SUBTITLE
import com.magd.m_media.hub.util.CONVERT_VTT
import com.magd.m_media.hub.util.DEFAULT
import com.magd.m_media.hub.util.DownloadUtil
import com.magd.m_media.hub.util.FORMAT_COMPATIBILITY
import com.magd.m_media.hub.util.FORMAT_QUALITY
import com.magd.m_media.hub.util.M4A
import com.magd.m_media.hub.util.NOT_CONVERT
import com.magd.m_media.hub.util.NOT_SPECIFIED
import com.magd.m_media.hub.util.OPUS
...
import com.magd.m_media.hub.util.RES_HIGHEST
import com.magd.m_media.hub.util.RES_LOWEST
import com.magd.m_media.hub.util.SUBTITLE_LANGUAGE
import com.magd.m_media.hub.util.ULTRA_LOW
import com.magd.m_media.hub.util.getStringDefault
...
private fun SubtitleLanguageDialogImpl(
    onDismissRequest: () -> Unit = {},
    initialLanguages: String = "ar.*,en.*,.*-orig",
    onReset: () -> Unit = {},
    onConfirm: (String) -> Unit = {},
) {
