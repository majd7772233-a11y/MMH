package com.magd.m_media.hub.util
...
import com.magd.m_media.hub.App.Companion.audioDownloadDir
import com.magd.m_media.hub.App.Companion.context
import com.magd.m_media.hub.App.Companion.videoDownloadDir
import com.magd.m_media.hub.Downloader
import com.magd.m_media.hub.Downloader.onProcessEnded
import com.magd.m_media.hub.Downloader.onProcessStarted
import com.magd.m_media.hub.Downloader.onTaskEnded
import com.magd.m_media.hub.Downloader.onTaskError
import com.magd.m_media.hub.Downloader.onTaskStarted
import com.magd.m_media.hub.Downloader.toNotificationId
...
import com.magd.m_media.hub.ui.page.settings.network.Cookie
import com.magd.m_media.hub.util.FileUtil.getArchiveFile
import com.magd.m_media.hub.util.FileUtil.getConfigFile
import com.magd.m_media.hub.util.FileUtil.getCookiesFile
import com.magd.m_media.hub.util.FileUtil.getExternalTempDir
import com.magd.m_media.hub.util.FileUtil.getFileName
import com.magd.m_media.hub.util.FileUtil.getSdcardTempDir
import com.magd.m_media.hub.util.FileUtil.moveFilesToSdcard
import com.magd.m_media.hub.util.PreferenceUtil.COOKIE_HEADER
